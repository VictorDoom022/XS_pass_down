<?php
  ...
  $sql_s_document_type="SELECT bilctrl_name AS listValue,bilctrl_desc AS listText FROM bill_control WHERE bilctrl_doc = 'SN' AND bilctrl_userdefine4 = '1' ORDER BY bilctrl_order, bilctrl_desc";
  ...
  $objTemplate->setTemplate("head_inv_trn_sn_list.html","head");
  $objTemplate->setTemplate("body_inv_trn_sn_list.html","body");
